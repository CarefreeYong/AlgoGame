...
import { Option, Size, Position, PositionStr, Direction, PathDirection, Vector, GridType, Grid as UnstableGrid, Path, Route } from '@/types'
...
const search = (resumed: boolean, finalCallback: (vectors: Vector[]) => void): void => {
    ...
    searchIntervalId = setInterval(async () => {
        ...
        const nextQueueMap: Map<PositionStr, Vector> = new Map()
